...
The pre-operational implementation of the services for flood preparedness in the
Caribbean supports both the reconstruction of past flood events and the
...
To read more about the pre-operational implementation in the Caribbean, please take a look at :download:`this presentation <../_static/UC1_tutorial/CopernicusLAC-caribbean.pdf>`
...
..
   ...
   If you encounter any issues accessing these workspaces, please contact
   **business-team@wasdi.cloud** and request access.
...
interface displays a list of all available layers (Figure 2). These
include all flood extent maps produced for selected past flood events.

.. image:: ../_static/UC1_tutorial/image2.png
   :width: 5.36131in
   :height: 3.14796in

Figure 2. CopernicusLAC – Past event archive Workspace
...
-  “\ **[CODE]_[StartDate]_[EndDate]_flood_sum_days_[N].tif**\ ” Cumulative
...
-  The selected layer will be displayed on the map, and the product
   should appear in the list of products in the Layer panel (Figure 17).
...
-  Find your layer of interest in your workspace, and select it (Figure
   18 - 1). The download option will appear on top the layer list
   (Figure 18 - 2).
