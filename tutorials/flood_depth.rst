...
Flood Depth Mapping Serivice Summary
-----------------------------------------
...
The landing page of the CopernicusLAC Specialized PE is available at: `https://coplac.wasdi.net/<https://coplac.wasdi.net/>`_
To access the Specialized PE with the developed services and data, you first need to create your account.

* The Specialized PE is available through: `https://coplac.wasdi.net/#/login-coplac`_
* Click on the **You do not have an account yet? `Sign up here<https://www.wasdi.net/auth/realms/wasdi/protocol/openid-connect/registrations?client_id=wasdi_client&redirect_uri=https%3A%2F%2Fwww.wasdi.net%2F%23%2Flogin&state=74f70630-4138-4022-94fd-1b9743ca5175&response_mode=fragment&response_type=code&scope=openid&nonce=e55a5a23-1292-40d2-8674-267fbaf12950>`_** Link:

.. figure:: ../_static/flood_depth/4_tutorial_sign_in.png
    :alt: sign in
    :align: center
    :figwidth: 80%
    :name: fig:flood_depth_sign_in
...
* After registering, please send an email to `business-team@wasdi.cloud<business-team@wasdi.cloud>`_ with the following information:
  ...
  * Note stating that you are a **CopernicusLAC user**.
  This step is necessary so we can assign you the appropriate subscription.

After registering, you can log in with your credentials. 
You will be redirected to the **Marketplace** page (`https://coplac.wasdi.net/#/marketplace<https://coplac.wasdi.net/#/marketplace>`_), where the available **Service Applications** are listed.

.. figure:: ../_static/flood_depth/5_tutorial_marketplace.png
    :alt: marketplace
    :align: center
    :figwidth: 80%
    :name: fig:flood_depth_marketplace
...
.. figure:: ../_static/flood_depth/6_tutorial_main_menu.png
    :alt: menu
    :align: center
    :figwidth: 80%
    :name: fig:flood_depth_menu

    CopernicusLAC Specialized PE main menu

* **Marketplace**: page where all the applications are available for end users with a simple and intuitive Interface. 
Choose your App, set your input data and get your results.

.. figure:: ../_static/flood_depth/6_tutorial_main_menu_marketplace.png
    :alt: menu
    :align: center
    :figwidth: 80%
    :name: fig:flood_depth_menu_marketplace

    CopernicusLAC Specialized PE main menu – Marketplace

* **Workspaces**: each user can work in one or more Workspaces. A Workspace is a collection of files (either original Earth Observation (EO) data or outputs generated by processing tools) grouped under the same “project.”
...
.. figure:: ../_static/flood_depth/8_tutorial_main_menu_workspace.png
    :alt: menu
    :align: center
    :figwidth: 80%
    :name: fig:flood_depth_menu_workspace
...
.. figure:: ../_static/flood_depth/9_tutorial_workspace_example.png
    :alt: workspace example
    :align: center
    :figwidth: 80%
    :name: fig:flood_depth_workspace_example
...
.. figure:: ../_static/flood_depth/10_tutorial_main_menu_documentation.png
    :alt: menu
    :align: center
    :figwidth: 80%
    :name: fig:flood_depth_menu_documentation

    CopernicusLAC Specialized PE main menu – Documentation


..figure:: ../_static/flood_depth/11_tutorial_online_docs.png
    :alt: documentation
    :align: center
    :figwidth: 80%
    :name: fig:flood_depth_documentation
...
Note: If you haven’t already generated a flood extent map in your workspace, you can create one using the Flood Extent Mapping Service App: `https://coplac.wasdi.net/#/cl_flood_extent/appDetails.`_static

.. figure:: ../_static/flood_depth/15_tutorial_app_select_workspace.png
    :align: select workspace
    :figwidth: 80%
    :name: fig:select_ws
...
.. figure:: ../_static/flood_depth/19_tutorial_advanced_params.png
    :alt: app advanced input
    :align: center
    :figwidth: 80%
    :name: fig:app_advanced_input
...
.. figure:: ../_static/flood_depth/20_tutorial_app_status.png
    :alt: app status
    :align: center
    :figwidth: 80%
    :name: fig:app_status
...
.. figure:: ../_static/flood_depth/21_tutorial_app_summary.png
    :alt: app summary
    :align: center
    :figwidth: 80%
    :name: fig:summary
